  ...
  return (
    <div style={{ display: 'flex', minHeight: '100vh', width: '100%', background: 'var(--bg-primary)', color: 'var(--text-primary)', fontFamily: 'sans-serif' }}>
      ...
      <main style={{ flex: 1, overflowY: 'auto', overflowX: 'hidden', minWidth: 0, paddingBottom: isMobile ? 64 : 0 }}>
        ...
        <div style={{ display: page === 'market'      ? 'block' : 'none' }}><Market holdings={portfolio.holdings} usdKrw={portfolio.usdKrw} isMobile={isMobile} /></div>
        <div style={{ display: page === 'watchlist'   ? 'block' : 'none' }}><Watchlist usdKrw={portfolio.usdKrw} isMobile={isMobile} /></div>
        <div style={{ display: page === 'dividend'    ? 'block' : 'none' }}><Dividend transactions={portfolio.transactions} holdings={portfolio.holdings} usdKrw={portfolio.usdKrw} isMobile={isMobile} /></div>
